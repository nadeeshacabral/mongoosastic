...
module.exports = function elasticSearchPlugin(schema, options){
  ...
  */
   ...
   *
   * @param query - query to filter the docs being synhcronized
   * @param delay - delay between indexing two documents
   */
  schema.statics.synchronize = function(query, delay){
    var model = this
